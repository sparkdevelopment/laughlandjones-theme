...
if( !class_exists( 'CMB2_Tabs' ) ) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-tabs', get_template_directory_uri() . '/cmb2-tabs/js/tabs.js', array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-tabs' );

            wp_enqueue_style( 'cmb-tabs', get_template_directory_uri() . '/cmb2-tabs/css/tabs.css', array(), self::VERSION );
